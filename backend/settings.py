...
DATABASES = {
    "default": dj_database_url.config(
        default="postgresql://indokonadatabase_user:XgLvGcjumRFi1m63jPabFFjnnu4YwnqN@dpg-d3mk042li9vc738412qg-a/indokonadatabase",
        conn_max_age=600,
        ssl_require=True
    )
}
...
EMAIL_HOST_PASSWORD = 'bolq hahz glyw uzlr'  # App Password (NOT Gmail password!)
